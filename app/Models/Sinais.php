...
class Sinais
{
     ...
     */
    public static function save($sinais, $agendamento_id)
    {
        // validação (bem simples, só pra evitar dados vazios)
        if (empty($sinais) && empty($agendamento_id)) {
        ...
        $stmt->bindParam(':data', $sinais['data']);
        $stmt->bindParam(':altura', $sinais['altura']);
        $stmt->bindParam(':peso', $sinais['peso']);
        $stmt->bindParam(':imc', $sinais['imc']);
        $stmt->bindParam(':temperatura', $sinais['temperatura']);
        $stmt->bindParam(':dor', $sinais['dor']);
